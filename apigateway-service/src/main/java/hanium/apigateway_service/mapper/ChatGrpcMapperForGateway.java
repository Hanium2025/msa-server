...
public class ChatGrpcMapperForGateway {
    ...
    public static CreateChatroomRequest toGrpc(CreateChatroomRequestDTO dto,Long memberId) {
        return CreateChatroomRequest.newBuilder()
    ...
    public static ListMyChatroomsRequest toGrpc(Long memberId){
        return ListMyChatroomsRequest.newBuilder()
